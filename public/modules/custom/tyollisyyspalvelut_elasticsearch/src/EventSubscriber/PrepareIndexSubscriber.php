...
class PrepareIndexSubscriber implements EventSubscriberInterface {
  ...
  private function getSynonyms(): array
  {
    return [
      ...
      "te_palvelut,	neuvonta",
      "te_palvelut,	verkkopalvelu",
      "te_palvelut,	puhelinpalvelut",
      "te_toimisto,	oma asiointi",
      "te_toimisto,	neuvonta",
      "te_toimisto,	verkkopalvelu",
      "te_toimisto,	puhelinpalvelut",
    ];
  }
